...
class SettingsValidator:
    ...
    def __init__(self):
        self.logger = get_logger("zashterm.settings.validator")
...
class SettingsManager:
    ...
    def __init__(self, settings_file: Optional[Path] = None):
        self.logger = get_logger("zashterm.settings.manager")
    ...
    def _load_settings_safe(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_error_with_context(e, "settings loading", "zashterm.settings")
            return self._defaults.copy()
            ...
            with self._lock:
                try:
                    ...
                    log_error_with_context(
                        e, "async settings saving", "zashterm.settings"
                    )
                    self._dirty = True
    ...
    def apply_gtk_terminal_theme(self, window) -> None:
        ...
        try:
            ...
            if luminance >= 0.05:
                ...
                css_parts.append(f"""
                popover.sidebar-popover.zash-popover > contents,
                popover.sidebar-popover > contents {{
                    background-color: {bg_color};
                    padding: 0;
                }}
                popover.sidebar-popover.zash-popover > arrow,
            ...
            if luminance >= 0.05:
                ...
                /* Specific zash classes for backward compatibility */
                popover.zash-popover > contents,
                popover.context-menu > contents {{
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                popover.zash-popover > arrow,
            ...
            if apply_dialog_bg:
                ...
                .zash-dialog > toolbarview {{
                    background-color: {bg_color};
                }}
                .zash-dialog > toolbarview > contents {{
                    background-color: {bg_color};
                }}
                .zash-dialog scrolledwindow {{
                    background-color: {bg_color};
                }}
                .zash-dialog scrolledwindow > viewport {{
                    background-color: {bg_color};
                }}
                .zash-dialog .navigation-view,
                .zash-dialog .preferences-page {{
                    background-color: {bg_color};
                    color: {fg_color};
                }}
                .zash-dialog .preferences-group {{
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                .zash-dialog > toolbarview label,
                .zash-dialog .preferences-page label,
                .zash-dialog row label,
                .zash-dialog .title,
                .zash-dialog .subtitle,
                .zash-dialog button:not(.suggested-action):not(.destructive-action),
                .zash-dialog entry,
                .zash-dialog row,
                .zash-dialog switch,
                .zash-dialog spinbutton,
                .zash-dialog dropdown,
                .zash-dialog checkbutton,
                ...
                .zash-dialog actionbar,
                .zash-dialog actionbar > revealer,
                .zash-dialog actionbar > revealer > box {{
                    background: {header_bg_color};
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                ...
                .zash-dialog button.destructive-action {{
                    background-color: #c01c28;
                    background-image: none;
                    color: #ffffff;
                    border: none;
                }}
                .zash-dialog button.destructive-action:hover {{
                    background-color: #a51d2d;
                }}
                .zash-dialog button.destructive-action label {{
                    color: #ffffff;
                }}
                
                /* Flat button styling */
                .zash-dialog button.flat {{
                    color: {fg_color};
                }}
                .zash-dialog button.flat:hover {{
                    background-color: color-mix(in srgb, {fg_color} {hover_alpha}, {bg_color});
                }}
