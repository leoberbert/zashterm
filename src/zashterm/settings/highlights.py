...
class HighlightManager(GObject.GObject):
    ...
    2. User Layer: JSON files from ~/.config/zashterm/highlights/ (user overrides)
    ...
    def __init__(self, config_path: Optional[Path] = None, settings_manager=None):
        ...
        self.logger = get_logger("zashterm.settings.highlights")
    ...
    def _get_system_highlights_path(self) -> Optional[Path]:
        ...
        try:
            ...
            if hasattr(resources, 'files'):
                # Python 3.9+
                pkg_path = resources.files('zashterm.data.highlights')
    ...
    def _load_layered_config(self) -> None:
        ...
        with self._lock:
            try:
                ...
                log_error_with_context(e, "loading layered config", "zashterm.highlights")
    ...
    def save_config(self) -> None:
        ...
        with self._lock:
            try:
                ...
                log_error_with_context(e, "saving highlight config", "zashterm.highlights")
    ...
    def save_global_rules_to_user(self) -> None:
        ...
        with self._lock:
            try:
                ...
                log_error_with_context(e, "saving global rules", "zashterm.highlights")
