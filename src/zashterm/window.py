...
class ZashWindow(Adw.ApplicationWindow):
    """
    ...
    def __init__(self, application, settings_manager: SettingsManager, **kwargs):
        ...
        self.logger = get_logger("zashterm.window")
    ...
    def _make_broadcast_terminal_key(self, terminal: Vte.Terminal) -> str:
        ...
        session = getattr(terminal, "zash_session_item", None)
    ...
    def _show_save_session_dialog(self):
        dialog = Adw.MessageDialog(
            ...
            body=_(
                "Do you want to restore these tabs the next time you open Zash?"
            ),
            close_response="cancel",
        )
