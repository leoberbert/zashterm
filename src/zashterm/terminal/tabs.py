...
class TabManager:
    def __init__(
        ...
        """
        self.logger = get_logger("zashterm.tabs.manager")
    ...
    def _create_tab_for_terminal(
        ...
        terminal.zash_parent_page = page
    ...
    def get_page_for_terminal(
        ...
        return getattr(terminal, "zash_parent_page", None)
    ...
    def _split_terminal(
        ...
        with self._creation_lock:
            ...
            new_terminal.zash_parent_page = page
