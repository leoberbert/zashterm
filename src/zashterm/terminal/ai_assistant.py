# zash/terminal/ai_assistant.py

"""AI assistant integration for Zash terminals."""
...
class TerminalAiAssistant(GObject.Object):
    ...
    def _detect_os_context() -> str:
        ...
        # If we found a base (e.g., "arch" for Arch/Manjaro, or "debian" for Ubuntu), include it
        if base_distro:
    ...
    def __init__(self, window, settings_manager, terminal_manager):
        super().__init__()
        self.logger = get_logger("zashterm.terminal.ai_assistant")
