...
class BaseModel(GObject.GObject):
    ...
    def __init__(self):
        ...
        self.logger = get_logger("zashterm.sessions.basemodel")
...
class SessionItem(BaseModel):
    ...
    def __init__(
        ...
        super().__init__()
        self.logger = get_logger("zashterm.sessions.model")
...
class SessionFolder(BaseModel):
    ...
    def __init__(self, name: str, path: str = "", parent_path: str = ""):
        super().__init__()
        self.logger = get_logger("zashterm.sessions.folder")
