...
class SessionStorageManager:
    ...
    def __init__(self):
        self.logger = get_logger("zashterm.sessions.storage")
    ...
    def _initialize_storage(self) -> None:
        ...
        try:
            ...
            handle_exception(
                e, "storage initialization", "zashterm.sessions.storage", reraise=True
            )
        ...
        with self._file_lock:
            try:
                ...
                log_error_with_context(
                    e, "load sessions and folders", "zashterm.sessions.storage"
                )
                raise StorageReadError(
    ...
    def save_sessions_and_folders_safe(
        ...
        with self._file_lock:
            try:
                ...
                log_error_with_context(
                    e, "save sessions and folders", "zashterm.sessions.storage"
                )
                raise StorageWriteError(
...
def load_sessions_to_store(
    ...
    logger = get_logger("zashterm.sessions.storage")
    try:
        ...
        handle_exception(e, "load sessions to store", "zashterm.sessions.storage")
...
def load_folders_to_store(
    ...
    try:
        ...
        handle_exception(e, "load folders to store", "zashterm.sessions.storage")
