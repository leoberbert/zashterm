...
class WindowUIBuilder:
    ...
    'what' (the widgets) from the 'how' (the event logic in ZashWindow).
    """

    def __init__(self, window: "ZashWindow"):
        self.window = window
        self.logger = get_logger("zashterm.ui.builder")
    ...
    def _setup_main_structure(self) -> Gtk.Box:
        ...
        self.sidebar_popover.add_css_class("zash-popover")
    ...
    def _create_header_bar(self) -> Adw.HeaderBar:
        ...
        self.cleanup_popover.add_css_class("zash-popover")
        ...
        self.single_tab_title_widget = Adw.WindowTitle(title=_("Zash"))
    ...
    def _on_toolbar_command_right_click(self, gesture, n_press, x, y, command):
        ...
        popover.add_css_class("zash-popover")
