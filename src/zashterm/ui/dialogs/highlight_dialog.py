# zash/ui/dialogs/highlight_dialog.py
"""
...
class RuleEditDialog(Adw.Window):
    ...
    def __init__(
        ...
        self.logger = get_logger("zashterm.ui.dialogs.rule_edit")
        self._parent = parent
...
class ContextRulesDialog(Adw.Window):
    ...
    def __init__(self, parent: Gtk.Widget, context_name: str):
        ...
        super().__init__()
        self.add_css_class("zash-dialog")
        self.logger = get_logger("zashterm.ui.dialogs.context_rules")
        self._parent = parent
...
class HighlightDialog(Adw.PreferencesWindow):
    ...
    def __init__(self, parent_window: Gtk.Window):
        ...
        self.add_css_class("zash-dialog")
        self.logger = get_logger("zashterm.ui.dialogs.highlight")
...
class ContextNameDialog(Adw.Dialog):
    ...
    def __init__(self, parent: Gtk.Widget):
        ...
        super().__init__()
        self.add_css_class("zash-dialog")
        self.logger = get_logger("zashterm.ui.dialogs.context_name")
        self._parent = parent
        self._manager = get_highlight_manager()
...
class AddTriggerDialog(Adw.Dialog):
    ...
    def __init__(self, parent: Gtk.Widget, context_name: str, existing_trigger: str = None):
        ...
        super().__init__()
        self.add_css_class("zash-dialog")
        self.logger = get_logger("zashterm.ui.dialogs.add_trigger")
        self._parent = parent
        self._context_name = context_name
...
class AddIgnoredCommandDialog(Adw.Dialog):
    ...
    def __init__(self, parent: Gtk.Widget):
        ...
        super().__init__()
        self.add_css_class("zash-dialog")
        self.logger = get_logger("zashterm.ui.dialogs.add_ignored_cmd")
        self._parent = parent
