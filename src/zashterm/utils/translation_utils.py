...
if 'APPIMAGE' in os.environ or 'APPDIR' in os.environ:
    ...
    # translation_utils.py is in: usr/share/zashterm/utils/translation_utils.py
    # We need to get to: usr/share/locale
    script_dir = os.path.dirname(os.path.abspath(__file__))  # usr/share/zashterm/utils
    app_dir = os.path.dirname(script_dir)                    # usr/share/zashterm
...
# Configure the translation text domain for zashterm
gettext.bindtextdomain("zashterm", locale_dir)
gettext.textdomain("zashterm")
